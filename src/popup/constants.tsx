...
export const Icons = {
  ...
  Notion: () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M4.459 4.208c.191-.252.541-.403.883-.403H19.5c.342 0 .692.151.883.403.191.252.261.594.191.916l-1.397 7.031c-.131.664-.714 1.144-1.397 1.144H6.214c-.683 0-1.266-.48-1.397-1.144L3.42 5.124c-.07-.322 0-.664.191-.916zM2 19c0-1.105.895-2 2-2h16c1.105 0 2 .895 2 2v1c0 1.105-.895 2-2 2H4c-1.105 0-2-.895-2-2v-1z" /></svg>
  ),
  PDF: () => (
